-- CreateEnum
CREATE TYPE "AddressType" AS ENUM ('COMPANY');
...
CREATE TABLE "Company" (
    ...
    "legalType" TEXT,
    "phoneNumber" TEXT,
    "lockedBeneficiaries" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "Company" ADD CONSTRAINT "Company_logoFileId_fkey" FOREIGN KEY ("logoFileId") REFERENCES "UploadedFile"("id") ON DELETE SET NULL ON UPDATE CASCADE;